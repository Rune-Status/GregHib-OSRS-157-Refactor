public class Class7 {
   ...
   static boolean decodeRegionHash(PacketBuffer packetbuffer_0, int int_0) {
      ...
      if (int_1 == 0) {
         ...
         if (Client.cachedPlayers[int_0] != null) {
            ...
            Player player_0 = Client.cachedPlayers[int_0] = new Player();
            player_0.anInt601 = int_0;
            if (Class27.aBufferArray1[int_0] != null) {
               player_0.decodeApperance(Class27.aBufferArray1[int_0]);
            }

            player_0.orientation = Class27.anIntArray19[int_0];
            player_0.interacting = Class27.anIntArray20[int_0];
            int_5 = Class27.anIntArray18[int_0];
            int_6 = int_5 >> 28;
            int_7 = int_5 >> 14 & 0xFF;
            int_8 = int_5 & 0xFF;
            player_0.aByteArray20[0] = Class27.aByteArray3[int_0];
            player_0.anInt600 = (byte)int_6;
         ...
         int_3 = Class27.anIntArray18[int_0];
         Class27.anIntArray18[int_0] = (((int_3 >> 28) + int_2 & 0x3) << 28) + (int_3 & 0xFFFFFFF);
         return false;
      } else {
         int int_4;
         int int_9;
         if (int_1 == 2) {
            ...
            int_3 = int_2 >> 3;
            int_4 = int_2 & 0x7;
            int_9 = Class27.anIntArray18[int_0];
            ...
            Class27.anIntArray18[int_0] = (int_6 << 14) + int_7 + (int_5 << 28);
            return false;
         } else {
            ...
            Class27.anIntArray18[int_0] = (int_7 << 14) + int_8 + (int_6 << 28);
            return false;
         }
      }
   }
