      ...
      if (Class4.localPlayer != player_0) {
         if (Client.menuOptionCount < 400) {
            ...
            if (Client.itemSelectionState == 1) {
               Class24.addMenuEntry("Use", Client.aString35 + " " + "->" + " " + WallObject.getColTags(16777215) + string_2, 14, int_0, int_1, int_2);
            } else if (Client.spellSelected) {
               if ((Enum4.anInt381 & 0x8) == 8) {
                  Class24.addMenuEntry(Client.aString34, Client.aString36 + " " + "->" + " " + WallObject.getColTags(16777215) + string_2, 15, int_0, int_1, int_2);
               }
            } else {
               for (int_6 = 7; int_6 >= 0; --int_6) {
                  if (Client.playerOptions[int_6] != null) {
                     ...
                     Class24.addMenuEntry(Client.playerOptions[int_6], WallObject.getColTags(16777215) + string_2, int_3, int_0, int_1, int_2);
                  }
               }
            }
            ...
            for (int_6 = 0; int_6 < Client.menuOptionCount; int_6++) {
               if (Client.menuTypes[int_6] == 23) {
                  Client.menuTargets[int_6] = WallObject.getColTags(16777215) + string_2;
                  break;
               }
            }
