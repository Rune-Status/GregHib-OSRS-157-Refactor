public class AClass1_Sub1 extends AClass1 {
   ...
   void method620(Buffer buffer_0, Buffer buffer_1) {
      ...
      if (int_0 != Class10.aClass10_1.anInt49) {
         ...
         this.anInt307 = buffer_1.getUnsignedByte();
         this.anInt308 = buffer_1.getUnsignedByte();
         this.anInt50 = buffer_1.getUnsignedShort();
         this.anInt51 = buffer_1.getUnsignedShort();
         this.anInt309 = buffer_1.getUnsignedByte();
         this.anInt310 = buffer_1.getUnsignedByte();
