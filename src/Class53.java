...
public class Class53 {
   ...
   static int method349(int int_0, int int_1) {
      ...
      return Class56.currentRequest != null && Class56.currentRequest.hash == long_0 ? WallDecoration.aBuffer4.position * 99 / (WallDecoration.aBuffer4.buffer.length - Class56.currentRequest.padding) + 1 : 0;
   }
