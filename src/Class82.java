public class Class82 {
   ...
   int method477(int int_0) {
      byte byte_0 = this.aBuffer5.buffer[this.aBuffer5.position];
      int int_3;
      if (byte_0 < 0) {
         int_3 = byte_0 & 0xFF;
         this.anIntArray44[int_0] = int_3;
         ++this.aBuffer5.position;
      } else {
      ...
      if (int_3 != 240 && int_3 != 247) {
         ...
         if (int_3 == 247 && int_1 > 0) {
            int int_2 = this.aBuffer5.buffer[this.aBuffer5.position] & 0xFF;
         ...
         this.aBuffer5.position += int_1;
         return 0;
      }
   }

   void method478() {
      this.aBuffer5.buffer = null;
   ...
   boolean method479() {
      return this.aBuffer5.buffer != null;
   }

   void method480(byte[] bytes_0) {
      this.aBuffer5.buffer = bytes_0;
      this.aBuffer5.position = 10;
      int int_0 = this.aBuffer5.getUnsignedShort();
      this.anInt180 = this.aBuffer5.getUnsignedShort();
      this.anInt179 = 500000;
      this.anIntArray42 = new int[int_0];

      int int_1;
      int int_3;
      for (int_1 = 0; int_1 < int_0; this.aBuffer5.position += int_3) {
         int int_2 = this.aBuffer5.readInt();
         int_3 = this.aBuffer5.readInt();
         if (int_2 == 1297379947) {
            this.anIntArray42[int_1] = this.aBuffer5.position;
            ++int_1;
         }
      }
   ...
   void method481(int int_0) {
      this.aBuffer5.position = this.anIntArray41[int_0];
   }
   ...
   int method486(int int_0, int int_1) {
      int int_2;
      if (int_1 == 255) {
         int int_5 = this.aBuffer5.getUnsignedByte();
         int_2 = this.aBuffer5.readVarInt();
         if (int_5 == 47) {
            this.aBuffer5.position += int_2;
            return 1;
         } else if (int_5 == 81) {
         ...
         int_2 = int_1;
         if (byte_0 >= 1) {
            int_2 = int_1 | this.aBuffer5.getUnsignedByte() << 8;
         }

         if (byte_0 >= 2) {
            int_2 |= this.aBuffer5.getUnsignedByte() << 16;
         }
   ...
   void method488() {
      this.aBuffer5.position = -1;
   }

   void method489(int int_0) {
      this.anIntArray41[int_0] = this.aBuffer5.position;
   }
   ...
   void method491(long long_0) {
      ...
      for (int int_1 = 0; int_1 < int_0; int_1++) {
         ...
         this.aBuffer5.position = this.anIntArray42[int_1];
         this.method485(int_1);
         this.anIntArray41[int_1] = this.aBuffer5.position;
      }
