...
public final class Client extends GameEngine {
   ...
   boolean method1100(Class46 class46_0) {
      RSSocket rssocket_0 = class46_0.method277();
      ...
      if (rssocket_0 == null) {
         ...
         try {
            ...
            if (class46_0.packetLength == -1) {
               ...
               class46_0.method277().read(packetbuffer_0.payload, 0, 1);
            ...
            if (class46_0.packetLength == -2) {
               ...
               class46_0.method277().read(packetbuffer_0.payload, 0, 2);
               packetbuffer_0.offset = 0;
            ...
            if (ServerPacket.aServerPacket4 == class46_0.serverPacket) {
            ...
            if (ServerPacket.aServerPacket10 == class46_0.serverPacket) {
               ...
               PacketNode packetnode_0 = Actor.method953(ClientPacket.aClientPacket12, aClass46_1.anISAACCipher1);
            ...
            if (ServerPacket.aServerPacket5 == class46_0.serverPacket) {
            ...
            while (true) {
               ...
               if (!bool_0) {
                  ...
                  if (aClass100_1.aBool30) {
                     packetnode_0 = Actor.method953(ClientPacket.aClientPacket10, aClass46_1.anISAACCipher1);
                  ...
                  synchronized(object_0) {
                     if (!aBool84) {
                        ...
                        packetnode_3 = Actor.method953(ClientPacket.aClientPacket5, aClass46_1.anISAACCipher1);
                  ...
                  if (MouseInput.anInt259 == 1 || !Item.aBool73 && MouseInput.anInt259 == 4 || MouseInput.anInt259 == 2) {
                     ...
                     int_4 = (int)long_0;
                     packetnode_1 = Actor.method953(ClientPacket.aClientPacket4, aClass46_1.anISAACCipher1);
                  ...
                  if (KeyFocusListener.anInt126 > 0) {
                     packetnode_0 = Actor.method953(ClientPacket.aClientPacket2, aClass46_1.anISAACCipher1);
                  ...
                  if (aBool92 && anInt637 <= 0) {
                     anInt637 = 20;
                     aBool92 = false;
                     packetnode_0 = Actor.method953(ClientPacket.aClientPacket7, aClass46_1.anISAACCipher1);
                  ...
                  if (Class12.aBool3 && !aBool90) {
                     aBool90 = true;
                     packetnode_0 = Actor.method953(ClientPacket.aClientPacket6, aClass46_1.anISAACCipher1);
                                       ...
                                       do {
                                          ...
                                          if (scriptevent_0 == null) {
                                                ...
                                                if (MouseInput.anInt263 == 0) {
                                                   if (aBool91) {
                                                      if (ClanMember.aWidget7 == Class52.aWidget2 && anInt635 != anInt693) {
                                                         ...
                                                         PacketNode packetnode_2 = Actor.method953(ClientPacket.aClientPacket84, aClass46_1.anISAACCipher1);
                                             ...
                                             if (Region.method381()) {
                                                ...
                                                PacketNode packetnode_4 = Actor.method953(ClientPacket.aClientPacket82, aClass46_1.anISAACCipher1);
                                             ...
                                             if (int_2 > 15000 && int_4 > 15000) {
                                                ...
                                                packetnode_1 = Actor.method953(ClientPacket.aClientPacket3, aClass46_1.anISAACCipher1);
                                                aClass46_1.method282(packetnode_1);
                                             }
                                             ...
                                             if (aClass46_1.anInt104 > 50) {
                                                packetnode_1 = Actor.method953(ClientPacket.aClientPacket1, aClass46_1.anISAACCipher1);
                                                aClass46_1.method282(packetnode_1);
                                             }
               ...
               packetnode_3 = Actor.method953(ClientPacket.aClientPacket8, aClass46_1.anISAACCipher1);
               packetnode_3.packetBuffer.putByte(0);
               int_2 = packetnode_3.packetBuffer.offset;
   ...
   void method1105() {
      RSSocket rssocket_0 = aClass46_1.method277();
      PacketBuffer packetbuffer_0 = aClass46_1.aPacketBuffer1;
      ...
      try {
         ...
         if (loginState == 1) {
            ...
            if (BaseVarType.aTask1.status == 1) {
               ...
               rssocket_0 = aClass46_1.method277();
               BaseVarType.aTask1 = null;
               loginState = 2;
            }
         }
         ...
         if (loginState == 4) {
            if (packetbuffer_0.offset < 8) {
               int_0 = rssocket_0.available();
               if (int_0 > 8 - packetbuffer_0.offset) {
                  int_0 = 8 - packetbuffer_0.offset;
               }

               if (int_0 > 0) {
                  rssocket_0.read(packetbuffer_0.payload, packetbuffer_0.offset, int_0);
                  packetbuffer_0.offset += int_0;
               }
            }

            if (packetbuffer_0.offset == 8) {
               packetbuffer_0.offset = 0;
               ScriptState.aLong21 = packetbuffer_0.readLong();
               loginState = 5;
            }
         }
         ...
         if (loginState == 5) {
            ...
            aClass46_1.method280();
            PacketBuffer packetbuffer_1 = new PacketBuffer(500);
            int[] ints_0 = new int[] {(int)(Math.random() * 9.9999999E7D), (int)(Math.random() * 9.9999999E7D), (int)(ScriptState.aLong21 >> 32), (int)(ScriptState.aLong21 & 0xFFFFFFFFFFFFFFFFL)};
            packetbuffer_1.offset = 0;
            packetbuffer_1.putByte(1);
            packetbuffer_1.putByte(anEnum3_5.rsOrdinal());
            packetbuffer_1.putInt(ints_0[0]);
            packetbuffer_1.putInt(ints_0[1]);
            packetbuffer_1.putInt(ints_0[2]);
            packetbuffer_1.putInt(ints_0[3]);
            switch(anEnum3_5.anInt343) {
            case 0:
            case 3:
               packetbuffer_1.put24bitInt(Class34.anInt95);
               packetbuffer_1.offset += 5;
               break;
            case 1:
               packetbuffer_1.putInt(((Integer) Buffer.preferences.preferences.get(Integer.valueOf(AClass6_Sub4.method867(Class25.username)))).intValue());
               packetbuffer_1.offset += 4;
               break;
            case 2:
               packetbuffer_1.offset += 8;
            }

            packetbuffer_1.putString(Class25.password);
            packetbuffer_1.encryptRsa(Class29.aBigInteger1, Class29.aBigInteger2);
            PacketNode packetnode_1 = Class26.method222();
            packetnode_1.clientPacket = null;
            packetnode_1.anInt350 = 0;
            packetnode_1.packetBuffer = new PacketBuffer(5000);
            packetnode_1.packetBuffer.offset = 0;
            if (gameState == 40) {
               packetnode_1.packetBuffer.putByte(Class60.aClass60_4.anInt157);
            } else {
               packetnode_1.packetBuffer.putByte(Class60.aClass60_3.anInt157);
            }

            packetnode_1.packetBuffer.putShort(0);
            int int_1 = packetnode_1.packetBuffer.offset;
            packetnode_1.packetBuffer.putInt(157);
            packetnode_1.packetBuffer.putBytes(packetbuffer_1.payload, 0, packetbuffer_1.offset);
            int int_2 = packetnode_1.packetBuffer.offset;
            packetnode_1.packetBuffer.putString(Class25.username);
            packetnode_1.packetBuffer.putByte((isResized ? 1 : 0) << 1 | (lowMemory ? 1 : 0));
            packetnode_1.packetBuffer.putShort(Tile.canvasWidth);
            packetnode_1.packetBuffer.putShort(Class29.canvasHeight);
            Node_Sub5.method695(packetnode_1.packetBuffer);
            packetnode_1.packetBuffer.putString(Class16.sessionToken);
            packetnode_1.packetBuffer.putInt(Class10.anInt48);
            ...
            packetnode_1.packetBuffer.putByte(Class65.anInt168);
            packetnode_1.packetBuffer.putInt(0);
            packetnode_1.packetBuffer.putInt(Varcs.indexInterfaces.crc);
            packetnode_1.packetBuffer.putInt(Class6.indexSoundEffects.crc);
            packetnode_1.packetBuffer.putInt(GrandExchangeOffer.configsIndex.crc);
            packetnode_1.packetBuffer.putInt(Class56.anIndexData2.crc);
            packetnode_1.packetBuffer.putInt(Tile.anIndexData5.crc);
            packetnode_1.packetBuffer.putInt(Class23.indexMaps.crc);
            packetnode_1.packetBuffer.putInt(Class38.indexTrack1.crc);
            packetnode_1.packetBuffer.putInt(Class4.indexModels.crc);
            packetnode_1.packetBuffer.putInt(Class34.indexSprites.crc);
            packetnode_1.packetBuffer.putInt(Class49.indexTextures.crc);
            packetnode_1.packetBuffer.putInt(AbstractSoundSystem.anIndexData1.crc);
            packetnode_1.packetBuffer.putInt(Class92.indexTrack2.crc);
            packetnode_1.packetBuffer.putInt(Class3.indexScripts.crc);
            packetnode_1.packetBuffer.putInt(Enum1.anIndexData4.crc);
            packetnode_1.packetBuffer.putInt(WorldMapType2.vorbisIndex.crc);
            packetnode_1.packetBuffer.putInt(Class61.anIndexData3.crc);
            packetnode_1.packetBuffer.putInt(RSCanvas.indexWorldMap.crc);
            packetnode_1.packetBuffer.encryptXtea(ints_0, int_2, packetnode_1.packetBuffer.offset);
            packetnode_1.packetBuffer.method722(packetnode_1.packetBuffer.offset - int_1);
            aClass46_1.method282(packetnode_1);
            aClass46_1.method283();
            aClass46_1.anISAACCipher1 = new ISAACCipher(ints_0);

            for (int int_3 = 0; int_3 < 4; int_3++) {
               ints_0[int_3] += 50;
            }

            packetbuffer_0.seed(ints_0);
            loginState = 6;
         }

         if (loginState == 6 && rssocket_0.available() > 0) {
            int_0 = rssocket_0.readByte();
         ...
         if (loginState == 7 && rssocket_0.available() > 0) {
            anInt648 = (rssocket_0.readByte() + 3) * 60;
            loginState = 8;
         }
         ...
         if (loginState == 8) {
            ...
            int int_4;
            int int_6;
            if (loginState == 9 && rssocket_0.available() >= 13) {
               boolean bool_1 = rssocket_0.readByte() == 1;
               rssocket_0.read(packetbuffer_0.payload, 0, 4);
               packetbuffer_0.offset = 0;
               bool_0 = false;
               if (bool_1) {
                  int_6 = packetbuffer_0.readOpcode() << 24;
                  int_6 |= packetbuffer_0.readOpcode() << 16;
                  int_6 |= packetbuffer_0.readOpcode() << 8;
                  int_6 |= packetbuffer_0.readOpcode();
               ...
               Class59.method390();
               rights = rssocket_0.readByte();
               aBool95 = rssocket_0.readByte() == 1;
               localInteractingIndex = rssocket_0.readByte();
               localInteractingIndex <<= 8;
               localInteractingIndex += rssocket_0.readByte();
               anInt678 = rssocket_0.readByte();
               rssocket_0.read(packetbuffer_0.payload, 0, 1);
               packetbuffer_0.offset = 0;
               ServerPacket[] serverpackets_0 = DecorativeObject.method460();
               int int_5 = packetbuffer_0.method906();
               if (int_5 < 0 || int_5 >= serverpackets_0.length) {
                  throw new IOException(int_5 + " " + packetbuffer_0.offset);
               }

               aClass46_1.serverPacket = serverpackets_0[int_5];
               aClass46_1.packetLength = aClass46_1.serverPacket.packetLength;
               rssocket_0.read(packetbuffer_0.payload, 0, 2);
               packetbuffer_0.offset = 0;
               aClass46_1.packetLength = packetbuffer_0.readUnsignedShort();
            ...
            if (loginState == 10) {
               if (rssocket_0.available() >= aClass46_1.packetLength) {
                  packetbuffer_0.offset = 0;
                  rssocket_0.read(packetbuffer_0.payload, 0, aClass46_1.packetLength);
                  ...
                  for (int_0 = 0; int_0 < 4; int_0++) {
                     for (int_6 = 0; int_6 < 104; int_6++) {
                        for (int_4 = 0; int_4 < 104; int_4++) {
                           groundItemDeque[int_0][int_6][int_4] = null;
                        }
                     }
                  }
                  ...
                  Class85.initializeGPI(packetbuffer_0);
                  Class87.anInt189 = -1;
                  WallObject.xteaChanged(false, packetbuffer_0);
                  aClass46_1.serverPacket = null;
               }

            } else {
               if (loginState == 11 && rssocket_0.available() >= 2) {
                  packetbuffer_0.offset = 0;
                  rssocket_0.read(packetbuffer_0.payload, 0, 2);
                  packetbuffer_0.offset = 0;
                  Class4.anInt25 = packetbuffer_0.readUnsignedShort();
                  loginState = 12;
               }

               if (loginState == 12 && rssocket_0.available() >= Class4.anInt25) {
                  packetbuffer_0.offset = 0;
                  rssocket_0.read(packetbuffer_0.payload, 0, Class4.anInt25);
                  packetbuffer_0.offset = 0;
                  String string_1 = packetbuffer_0.readString();
                  String string_0 = packetbuffer_0.readString();
                  String string_2 = packetbuffer_0.readString();
               ...
               if (loginState != 13) {
                  ...
                  if (rssocket_0.available() >= aClass46_1.packetLength) {
                     ...
                     ScriptVarType.method469();
                     Class85.initializeGPI(packetbuffer_0);
                     if (int_0 != packetbuffer_0.offset) {
         ...
         if (MouseInput.anInt263 == 0) {
            if (aBool93) {
               ...
               if (aWidget13 != null) {
                  ...
                  if (widget_1 != null) {
                     PacketNode packetnode_0 = Actor.method953(ClientPacket.aClientPacket13, aClass46_1.anISAACCipher1);
