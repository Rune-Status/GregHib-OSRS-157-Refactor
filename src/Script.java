public class Script extends CacheableNode {
   ...
   static void method910(int int_0, int int_1, int int_2, int int_3, SpritePixels spritepixels_0, CacheableNode_Sub1 cacheablenode_sub1_0) {
      ...
      if (int_4 > 4225 && int_4 < 90000) {
         ...
         int int_10 = cacheablenode_sub1_0.anInt467 / 2 - 25;
         int int_11 = (int)(Math.sin(double_0) * (double)int_10);
         int int_12 = (int)(Math.cos(double_0) * (double)int_10);
         byte byte_0 = 20;
         Class10.mapedge.method997(int_11 + (int_0 + cacheablenode_sub1_0.anInt467 / 2 - byte_0 / 2), cacheablenode_sub1_0.anInt468 / 2 + int_1 - byte_0 / 2 - int_12 - 10, byte_0, byte_0, 15, 15, double_0, 256);
      } else {
